...
@section('title', 'Form Tambah Data Pengunjung')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <p class="mb-0">Tambah Pengunjung</p>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('storeVisitor') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" name="tanggal_kunjungan" id="tanggal_kunjungan" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
